...
class ApiRoute extends ApiRouteSpec implements IRouter
{
	 ...
	 */
	private $actions = [
		Nette\Http\IRequest::POST => false,
		Nette\Http\IRequest::GET => false,
		Nette\Http\IRequest::PUT => false,
		Nette\Http\IRequest::DELETE => false,
		Nette\Http\IRequest::OPTIONS => false,
		Nette\Http\IRequest::PATCH => false,
	];
	...
	private $default_actions = [
		...
		Nette\Http\IRequest::PUT => 'update',
